...
public class StatsSystem : MonoBehaviour
{
    ...
    public void CalculateDancingStats()
    {
        ...
        float floatStyle = (float)style;
        floatStyle = strength * strengthMultiplier;
        style = (int)floatStyle;
        ...
        float floatLuck = (float)luck;
        floatLuck = intelligence * intelligenceMultiplier;
        luck = (int)floatLuck;
        // luck should be based off our intelligence and be converted at a rate of 1 : 1.5f
        float floatRhythm = (float)rhythm;
        floatRhythm = agility * agilityMultiplier;
        rhythm = (int)floatRhythm;
    ...
    public void DistributePhysicalStatsOnLevelUp(int PointsPool)
    {
        ...
        int beforeLevelUp = strength + agility;
        strength += Random.Range(1, PointsPool/2);
        agility += Random.Range(1, PointsPool/2);
        int afterLevelUp = strength + agility;
        PointsPool -= (afterLevelUp - beforeLevelUp);
