...
public class FightManager : MonoBehaviour
{
    ...
    private void DecideWinner(Character teamACharacter, Character teamBCharacter)
    {
        ...
        {
            string playerOne = teamACharacter.charName.GetFullCharacterName() + " " + "wins!";
            BattleLog.Log(playerOne, teamAColour);
            teamBCharacter.myStatsSystem.ChangeHealth(-1f);
        ...
        {
            string playerTwo = teamBCharacter.charName.GetFullCharacterName() + " " + "wins!";
            BattleLog.Log(playerTwo, teamBColour);
            teamACharacter.myStatsSystem.ChangeHealth(-1f);
