...
public class CharacterNameGenerator : MonoBehaviour
{
    ...
    public void CreateNames()
    {
        ...
        firstNames.InsertRange(firstNames.Count, new List<string> {"Tom","Brady","Josh","Harry","Ron","Joe"});
        lastNames.InsertRange(lastNames.Count, new List<string> {"Smith","Johnson","Williams","Brown","Jones","Garcia"});
        nicknames.InsertRange(nicknames.Count, new List<string> {"Ed","Eddie","Eddy","Edd","Edward","Edwin"});
    }
